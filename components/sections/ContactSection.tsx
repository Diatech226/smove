...
export default function ContactSection({
  ...
  return (
    <motion.section
      ...
      onViewportEnter={() => onSectionIn?.("contact")}
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true, margin: "-30%" }}
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(250,204,21,0.16),transparent_35%),radial-gradient(circle_at_85%_15%,rgba(59,130,246,0.22),transparent_35%)]" aria-hidden />
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          <motion.div className="space-y-5" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
            <p className="text-base text-blue-50/90">
              Whether it’s daily social content, a launch campaign, or community management, SMOVE steps in with a full team so you don’t have to coordinate freelancers.
            </p>
            <div className="grid gap-4 rounded-2xl border border-white/10 bg-white/5 p-5 text-sm text-blue-50/90">
              ...
              <div className="flex flex-wrap gap-2 text-[13px] text-blue-50/90">
          ...
          >
            <label className="text-sm text-blue-50" htmlFor="name">
              ...
              <input
                ...
                className="mt-2 w-full rounded-lg border border-white/15 bg-blue-950/50 px-3 py-2 text-sm text-white outline-none transition focus:border-yellow-200 focus:ring-2 focus:ring-yellow-200/60"
              />
            </label>
