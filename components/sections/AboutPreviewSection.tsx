      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="space-y-4 lg:max-w-xl">
          ...
          <p className="text-slate-200">
            SMOVE Communication naît de la rencontre entre stratèges, créatifs et producteurs
            audiovisuels. Notre mission : donner du mouvement à vos idées, du concept à la
            diffusion.
          </p>
          <Link
            href="/about"
